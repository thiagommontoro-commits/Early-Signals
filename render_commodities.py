# ==========================================================================
# RENDERIZADOR HTML - COMMODITY INTELLIGENCE (com preços regionais)
# ==========================================================================
...
def _bloco_regional(regionais):
    """Faixa compacta de preços regionais em US$ dentro do card."""
    if not regionais:
        return ""
    linhas = ""
    for r in regionais:
        linhas += (f'<div class="reg-row"><span class="reg-uf">{r["uf"]}</span>'
                   ...
                   f'<span class="reg-delta">{_delta_inline(r.get("delta_mm"))}</span></div>')

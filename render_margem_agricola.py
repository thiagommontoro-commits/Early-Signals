# -*- coding: utf-8 -*-
"""
render_margem_agricola.py  (v3.1 — Receita Bruta + Margem Bruta + Margem Econômica)
==================================================================================
...
Insight "Aperto Econômico" (Spread = Margem Bruta - Margem Econômica): quanto
do resultado é consumido por terra/capital/depreciação — sinal antecedente de
decisão de investimento em máquinas.

Grid auto-fit (mesmo padrão visual das abas Commodities/Crédito).
...
CSS_MARGEM = """
<style>
/* ===== EARLY SIGNALS · Aba Margem do Produtor v3.1 (CONAB COE/COT/CT) ===== */
...
/* Grid auto-fit — mesmo padrão das abas Commodities/Crédito. */
